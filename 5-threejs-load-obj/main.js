...
function main() {
...

  {
    ...
    function frameArea(sizeToFitOnScreen, boxSize, boxCenter, camera) {
      ...
      const distance = halfSizeToFitOnScreen / Math.tan(halfFovY); // jarak from camera
      ...
      const direction = (new THREE.Vector3())
        ...
        .normalize(); // agar kamera langsung mengarah tepat object dari depan
